A list of 100 random numbers is given below:
...
If we use it as a random table to generate a series of random numbers, ie:
...
p[46] = 6  <-- 4th number
...
What's the 77th number in the series?